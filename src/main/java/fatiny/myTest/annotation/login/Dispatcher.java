...
import fatiny.myTest.annotation.login.handler.BagHandler;
import fatiny.myTest.annotation.login.handler.WeaponHandler;
...
public class Dispatcher {
	...
	private final Map<Short, Commander> commanders = new HashMap<>();
