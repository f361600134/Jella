...
public class StringHelper {
	...
	public static void main(String[] args) {
		...
		String bb = "jk_";
		String substringAfter = StringHelper.substringAfter(aa, bb);
		String substringBefore = StringHelper.substringBefore(aa, bb);
		String substringBeforeLast = StringHelper.substringBeforeLast(aa, bb);
		String substringAfterLast = StringHelper.substringAfterLast(aa, bb);
