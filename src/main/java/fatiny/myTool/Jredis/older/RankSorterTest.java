package fatiny.myTool.Jredis.older;
...
//		for (int i = 10000; i > 1 ; i--) {
		...
		rankInfo = new RankInfo((long)(20), "a"+20, 20, startTime+20); //+1
		rankSorter.add(rankName, rankInfo);
	}
	...
	public void putAll(){
		...
		long startTime = System.currentTimeMillis();
		rankSorter.addAll(rankName, map);
		logger.debug("消耗时间: {}ms", (System.currentTimeMillis() - startTime));
		rankSorter.size(rankName);
//		List<RankScoreObject> list = rankSorter.range(rankName, 0, 100);
