 ...
 * @author 
 */
public class CentralRedisCache extends RedisClient {

	public CentralRedisCache(String propertiesFile) {
	 ...
	 * @param expireTime
	 */
	public CentralRedisCache(String ip, int port, int maxTotal, int maxIdle,
			String password) {
